      ...
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            />
            {errors.patientNumber && <p className="text-red-500 text-sm">{errors.patientNumber}</p>} {/* Display error message */}
          </div>
          <div>
            ...
            <input
              ...
              required // Input is required for form submission
            />
            {errors.caseNumber && <p className="text-red-500 text-sm">{errors.caseNumber}</p>} {/* Display error message */}
          </div>
          <div>
            ...
            <input
              ...
              required // Input is required for form submission
            />
            {errors.patientName && <p className="text-red-500 text-sm">{errors.patientName}</p>} {/* Display error message */}
          </div>
          <div>
            ...
            <select
              ...
              required // Input is required for form submission
            >
              <option value="" disabled>Select Doctor</option> {/* Default disabled option */}
              {doctors.map((doctor) => (
                <option key={doctor} value={doctor}>{doctor}</option> // Map through doctors to create options
              ))}
            </select>
            {errors.doctorName && <p className="text-red-500 text-sm">{errors.doctorName}</p>} {/* Display error message */}
          </div>
